...
export const GET = async () => {
  ...
  const pages: string[] = [
    ...
    `${site}/sharepoint-microsoft-365-laravel`,
    `${site}/prodotti`,
    `${site}/prodotti/auditready`,
    `${site}/prodotti/hooplytics`,
    `${site}/chi-siamo`,
    `${site}/contatti`,
    `${site}/landing/devisia`,
    `${site}/landing/sistemi-spiegabili`,
    `${site}/landing/governance-ai`,
    `${site}/landing/processi-prima-automazione`,
    `${site}/landing/evidenze-audit`,
    `${site}/blog`,
    `${site}/privacy`,
    ...
    `${site}/en/sharepoint-microsoft-365-laravel`,
    `${site}/en/products`,
    `${site}/en/products/auditready`,
    `${site}/en/products/hooplytics`,
    `${site}/en/about`,
    `${site}/en/blog`,
    `${site}/en/contact`,
    `${site}/en/privacy`,
