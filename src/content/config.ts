...
const pageSchema = z.object({
  ...
  homeAIStructureTitle: optionalString,
  homeAIStructureDescription: optionalString,
  homeAIStructureItems: z.array(z.string()).optional().nullable(),
  homeAIStructureCtaLabel: optionalString,
  homeAIStructureCtaHref: optionalString,
